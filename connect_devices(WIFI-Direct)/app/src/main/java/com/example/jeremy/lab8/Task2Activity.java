...
public class Task2Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    PeerListListener myPeerListListener = new PeerListListener() {
        ...
        public void onPeersAvailable(WifiP2pDeviceList peerList) {
            ...
            if(!peerList.getDeviceList().equals(peers)){
                ...
                ArrayAdapter<String> adapter = new ArrayAdapter<String>(Task2Activity.this, android.R.layout.simple_list_item_1, deviceNameArray);
    ...
    public class WiFiDirectBroadcastReceiver extends BroadcastReceiver {
        ...
        private Channel mChannel;
        private Task2Activity mActivity;

        public WiFiDirectBroadcastReceiver(WifiP2pManager manager, Channel channel, Task2Activity activity) {
            super();
    ...
    public void initializeWifiDirect(){
        ...
        receiver = new WiFiDirectBroadcastReceiver(WD_Manager, mChannel, this);
